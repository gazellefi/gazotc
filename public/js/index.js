...
let pathUrl = 'https://gazotc.com:4242'
...
const startIdentityVerification = function () {
  ...
  fetch(pathUrl + "/create-verification-session", {
    method: "POST",
    headers: {
...
window.onload = function () {
  startButton = document.querySelector('#create-verification-session');
...
const addRedirectToIdentityVerification = function () {
  return fetch(pathUrl + "/create-verification-session-redirect", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
