...
<template>
  <div class="qianbao">
    <van-nav-bar :title="$t('message.dapp.legalWallet')" right-text="" left-arrow :fixed="true" :placeholder="true" z-index="99" @click-left="goback" />
    <div class="qianbao_view">
      <div class="qianbao_view_head">
        <div class="qianbao_view_head_item">
          <div class="qianbao_view_head_item_li" style="
                    font-size: 14px;
                    color: #fff;">
            <div style="opacity: 0.5;">Net capital assets</div> <i class="el-icon-view" style="opacity:0.5"></i>
          </div>
      ...
      <div class="qianbao_view_cd">
        ...
        <div class="qianbao_view_cd_item" @click="openurl('./baozhengjin')">
          <i class="el-icon-refresh-right"></i><span>Margin transfer</span>
        </div>
      </div>
      ...
      <div class="qianbao_view_ul">
        ...
        <div class="qianbao_view_ul_li" v-for="(li,index) in list" :key="index">
          ...
          <div class="qianbao_view_ul_li_item item" style="width: 20%;" v-if="li.key == 'baozhengjing'">
            <el-link type="primary" @click="openurl('./baozhengjin')">to change into</el-link>
            <el-link type="danger" style="margin-left: 5px;" @click="openurl('./baozhengjin')">Transfer out</el-link>
          </div>
          <div class="qianbao_view_ul_li_item item" style="width: 20%;" v-if="li.key != 'baozhengjing'">
