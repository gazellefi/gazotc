export default {
	...
	en: {
		message: {
			...
			netDes: 'Please switch the network to the coin security intelligent main network',
			Waiting: 'Waiting',
			copy: 'Copy',
			bond: 'Bond',
			unknown: 'Unknown',
	...
	zh: {
		message: {
			...
			setEncrypt:'请输入明文',
			state: '状态',
			notFill: '请在discord交易频道(https://discord.gg/2DVfmvUBgH)或telegram交易群(https://t.me/GazotcTrade)联系我，也可通过加密私信传递你的联系方式，我会尽快联系你。圣诞快乐!',
			operation: '操作',
			other: '其他',
			details: '详情',
			loadMore: '加载更多',
