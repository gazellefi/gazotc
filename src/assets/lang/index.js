export default {
  ...
  en: {
    message: {
	  ...
	  unilateralAgrees: 'Consent Release',
      ...
      dapp: {
        ...
        coinNet: 'BSC',
        HecoNet: 'Huobi Eco',
        EthereumRinkeby: 'Eth Rinkeby',
        EthereumNet: 'Ethereum',
        WaveNet: 'Tron',
        ...
        legalWallet: 'Fiat Money Wallet',
        CoinWallet: 'Crypto Wallet',
        ...
        arbitratorsLister: 'First Arbitration List',
        ArbitrationList: 'Arbitration List',
        firstOrders: 'First Round List',
		firstOrdersList:'First Arbitration List',
		secondOrderList:'Second Arbitration List',
        myPart: 'My participate',
		myPart2: 'Second Round State',
		myPart1: 'First Round State',
		myOrder: 'Participate Order',
		succeedOrderL: 'Successfully Order',
  ...
  zh: {
    message: {
	  ...
	  home:{
		  ...
		  aboutContent:'GAZOTC致力于为用户提供小而精的DOTC服务，打造一个安全、便捷、DAO去中心化的OTC平台。',
		  open:'开启操作',
		  howDo:'GAZOTC 如何运行',
		  safe:'安全',
		  ...
		  daoAutonomy:'DAO自治',
		  daoAutonomyContent:'如有争议，由链上中心化仲裁机制决定；平台参数由DAO社区投票决定',
		  market:'市场参与者',
		  business:'商家',
		  businessContent:'发布订单需抵押平台币',
		  user:'用户',
		  userContent:'购买订单需抵押平台币',
		  arbiter:'仲裁者',
		  arbiterContent:'争议仲裁需要平台币抵押',
		  economic:'经济模型',
		  reward:'奖励',
		  gazelle:'基金会',
		  private:'私募',
