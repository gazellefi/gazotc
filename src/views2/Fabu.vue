    ...
    <div cclass="add">
      <div class="add_form">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input :placeholder="$t('message.enterContent')" v-model="form.dj" @blur="jsbzj" :disabled="user['user'] ? false:true">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input :placeholder="$t('message.enterContent')" v-model="form.num" @blur="jsbzj" :disabled="user['user'] ? false:true">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input :placeholder="$t('message.enterContent')" v-model="form.zd_num" :disabled="user['user'] ? false:true">
              <template slot="append">{{pro}}</template>
            </el-input>
          </div>
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input :placeholder="$t('message.enterContent')" v-model="form.zg_num" :disabled="user['user'] ? false:true">
              <template slot="append">{{pro}}</template>
            </el-input>
          </div>
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input :placeholder="$t('message.enterContent')" v-model="form.user_bzj" :disabled="user['user'] ? false:true">
