        ...
        <div class="qianbao_view">
            <div class="qianbao_view_head">
                <div class="qianbao_view_head_item">
                    ...
                    font-size: 14px;
                    color: #fff;">
                        <div style="opacity: 0.5;">锁仓中的资产(gaz)</div> <i class="el-icon-view" style="opacity:0.5"></i>
                    </div>
            ...
            <div class="qianbao_view_headf">
                <div class="qianbao_view_head_item">
                    ...
                    font-size: 14px;
                    color: #fff;">
                        <div style="opacity: 0.5;">可提现资产(gaz)</div> <i class="el-icon-view" style="opacity:0.5"></i>
                    </div>
                    <div class="qianbao_view_head_item_li numarr">
            ...
            <div class="qianbao_view_cd">
                <div class="qianbao_view_cd_item" @click="tixianajax">
                    <i class="el-icon-refresh-right"></i><span>提现</span>
                </div>
            </div>
        </div>
    </div>
