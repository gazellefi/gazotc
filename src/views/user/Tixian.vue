...
<template>
  <div class="chongzhi">
    <van-nav-bar title="提款" right-text="" left-arrow :fixed="true" :placeholder="true" @click-left="goback" z-index="99" />
      ...
      <div class="czhiview_form">
        ...
        <div class="czhiview_form_shurk">
          ...
          <div class="czhiview_form_shurk_msg">
            You can withdraw the amount {{ (this.huobi[this.hbindex]['je']/ (10**huobi[hbindex]['num'])).toFixed(2)  }}
          </div>
        </div>
