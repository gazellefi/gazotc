  ...
  <div class="beizhua">
    ...
    <div class="view">
      <div class="view_page_a" style="margin-top: 0px">
        ...
        <div class="view_page_a_item" v-if="!user">
          <el-input type="textarea" :placeholder="$t('message.enterContent')" :autosize="{ minRows: 2, maxRows: 4}" v-model="inputval">
          </el-input>
        </div>
        <div class="view_page_a_item" v-if="!user">
...
export default {
  ...
  methods: {
    ...
    setbeizhu() {
		var that = this
      if (!this.inputval) {
        Notify({ type: 'warning', message: :that.$t('message.enterContent') });
        return;
      }
