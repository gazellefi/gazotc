      ...
      <div class="ddgl_fabu_p_head">
        ...
        <div class="ddgl_fabu_p_head_sxan">
          ...
          <div class="ddgl_fabu_p_head_sxan_i">
            <el-dropdown>
              <span class="el-dropdown-link">
                sell <i class="el-icon-arrow-down el-icon--right"></i>
              </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="1">whole</el-dropdown-item>
                <el-dropdown-item command="2">sell</el-dropdown-item>
                <el-dropdown-item command="3">purchase</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
          <div class="ddgl_fabu_p_head_sxan_i">
        ...
        <!-- <div class="ddgl_fabu_p_head_fabu">Issue entrustment order</div> -->
      </div>
      ...
      <div class="ddgl_fabu_ul">
        ...
        <div class="ddgl_fabu_ul_item" v-for="(li,index) in list" :key="index">
          ...
          <div class="ddgl_fabu_ul_li" style="opacity: 1;">
            <van-button plain type="info" size="small" @click="openinfo(li.ddid)">Details</van-button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="ddgl_fabu_wap_ul">
        <div class="ddgl_fabu_wap_ul_li" v-for="(li,index) in list" :key="index">
          <div class="ddgl_fabu_wap_ul_li_item">
            ...
            <div class="ddgl_fabu_wap_ul_li_item_r">Type:{{ li.type }} </div>
          </div>
          <div class="ddgl_fabu_wap_ul_li_item">
            <div class="ddgl_fabu_wap_ul_li_item_l">number:{{ li.Uoa }} {{ li.pro }}</div>
            <div class="ddgl_fabu_wap_ul_li_item_r">Unit Price</div>
          </div>
          <div class="ddgl_fabu_wap_ul_li_item">
            <div class="ddgl_fabu_wap_ul_li_item_l">Merchant deposit:{{ li.mma }} usdt</div>
            <div class="ddgl_fabu_wap_ul_li_item_r" style="color: rgb(100, 200, 104);">{{ li.unit }} CNY</div>
          </div>
          <div class="ddgl_fabu_wap_ul_li_item">
            <div class="ddgl_fabu_wap_ul_li_item_l">User deposit:{{ li.uma }} usdt</div>
          </div>
          <div class="ddgl_fabu_wap_ul_li_item">
            <div class="ddgl_fabu_wap_ul_li_item_l">Asset release:</div>
            <div class="ddgl_fabu_wap_ul_li_item_r" style="color: #f33;">{{ li.zcsf_msg }}</div>
          </div>
          <div class="ddgl_fabu_wap_ul_li_item">
            <div class="ddgl_fabu_wap_ul_li_item_l">Margin release:</div>
            <div class="ddgl_fabu_wap_ul_li_item_r" style="color: #f33;">{{ li.bzj_msg }}</div>
          </div>
          <div class="ddgl_fabu_wap_ul_li_item">
            <div class="ddgl_fabu_wap_ul_li_item_l">In Arbitration:</div>
            <div class="ddgl_fabu_wap_ul_li_item_r" style="color: #f33;">no</div>
          </div>
          <div class="ddgl_fabu_wap_ul_li_item">
            <van-button type="primary" @click="openinfo(li.ddid)">Details</van-button>
          </div>
        </div>
      </div>
    </div>
