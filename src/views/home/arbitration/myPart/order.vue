<template>
	<div>
		...
		<div class="hidden-sm-and-down" style="width: 100%;">
			<el-container>
			  <el-table :data="my_ss_tlist" style="width: 100%">
			    ...
			    <el-table-column prop="arb" align="center" :label="$t('message.arbitration.TwoarbitrationState')" :filters="oneLeveThree" :filter-method="filterTag" filter-placement="bottom-end">
			      <template slot-scope="scope">
		...
		<!-- 详情弹框 -->
		<el-dialog :title="$t('message.arbitration.myPartOrderTitle')" :visible.sync="dyl_zc.code" center :show-close="false"  :width="isphone ? '90%':'50%'">
