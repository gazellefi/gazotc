    ...
    <div cclass="add">
      <div class="add_form">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input placeholder="Please enter the content" v-model="form.dj" @blur="jsbzj">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input placeholder="Please enter the content" v-model="form.num" @blur="jsbzj">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input placeholder="Please enter the content" v-model="form.zd_num">
              <template slot="append">{{pro}}</template>
            </el-input>
          </div>
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input placeholder="Please enter the content" v-model="form.zg_num">
              <template slot="append">{{pro}}</template>
            </el-input>
          </div>
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_input">
            <el-input placeholder="Please enter the content" v-model="form.user_bzj">
