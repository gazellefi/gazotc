        ...
        <div class="ddgl_fabu_p_head_sxan">
          <div class="ddgl_fabu_p_head_sxan_i">
            <el-dropdown @command="saixuanpro">
              <span class="el-dropdown-link">
                {{ sxarr['pro'] == "ALL"? 'all':sxarr['pro']  }} <i class="el-icon-arrow-down el-icon--right"></i>
              </span>
          ...
          <div class="ddgl_fabu_p_head_sxan_i">
            <el-dropdown @command="saixuantcode">
              <span class="el-dropdown-link">
                {{ sxarr['tcode'] == "ALL"? 'all':sxarr['tcode'] == "C" ? 'for sale':'purchase' }} <i class="el-icon-arrow-down el-icon--right"></i>
              </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="ALL">whole</el-dropdown-item>
          ...
          <div class="ddgl_fabu_p_head_sxan_i">
            <el-dropdown @command="saixuanfli">
              <span class="el-dropdown-link">
                {{ sxarr['fli'] == "ALL"? 'all':sxarr['fli']  }} <i class="el-icon-arrow-down el-icon--right"></i>
              </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="ALL">whole</el-dropdown-item>
