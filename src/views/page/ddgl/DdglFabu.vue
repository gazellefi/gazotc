...
<template>
    <div class="ddgl_fabu">
                ...
                <div class="ddgl_fabu_p_head_sxan">
                    <div class="ddgl_fabu_p_head_sxan_i">
                        ...
                        <span class="el-dropdown-link">
                            {{ sxarr['pro'] == "ALL"? '全部':sxarr['pro']  }} <i class="el-icon-arrow-down el-icon--right"></i>
                        </span>
                    ...
                    <div class="ddgl_fabu_p_head_sxan_i">
                        ...
                        <span class="el-dropdown-link">
                            {{ sxarr['tcode'] == "ALL"? '全部':sxarr['tcode'] == "C" ? '出售':'购买'  }} <i class="el-icon-arrow-down el-icon--right"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="ALL">全部</el-dropdown-item>
                            <el-dropdown-item command="C">出售</el-dropdown-item>
                            <el-dropdown-item command="M">购买</el-dropdown-item>
                        </el-dropdown-menu>
                        </el-dropdown>
                    </div>
                    <div class="ddgl_fabu_p_head_sxan_i">
                        ...
                        <span class="el-dropdown-link">
                            {{ sxarr['fli'] == "ALL"? '全部':sxarr['fli']  }} <i class="el-icon-arrow-down el-icon--right"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="ALL">全部</el-dropdown-item>
        ...
        <div class="hidden-sm-and-up ddgl_fabu_wapview">
            ...
            <div class="ddgl_fabu_wap_ul">
                <div class="ddgl_fabu_wap_ul_li" v-for="(li,index) in list" :key="index">
                    ...
                    <div class="ddgl_fabu_wap_ul_li_item">
                        <div class="ddgl_fabu_wap_ul_li_item_l">限额：{{ li.zer }} -  {{ li.mal }} {{ li.pro }}</div>
        ...
        <el-dialog
        title="修改订单"
        :visible.sync="pcxgcode"
        :width="type_code == 1 ? '30%':'90%'">
        <span>
            <el-form  label-width="80px" v-model="set_form">
                ...
                <el-form-item label="单价" v-if="set_form.tcode == 1">
                    <el-input v-model="set_form.danjia"></el-input>
                </el-form-item>
                <el-form-item label="" v-if="set_form.tcode == 1">单价为0表示双方协议！</el-form-item>
            </el-form>
        </span>
        <span slot="footer" class="dialog-footer">
            <el-button @click="xiugaiajax(1)">取 消</el-button>
            <el-button type="primary" @click="xiugaiajax(2)">修 改 {{ set_form.tcode == 1 ? '单 价':set_form.tcode == 2 ? '数 量':'' }}</el-button>
        </span>
        </el-dialog>
    </div>
</template>
